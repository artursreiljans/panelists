...
#[Route(
    path: '/panelists/{id}/delete',
    name: self::class,
    requirements: ['id' => '\d+'],
    methods: ['GET', 'POST'],
)]
#[Template('layouts/form.html.twig')]
final class PanelistDeleteController extends AbstractController
{
    ...
    public function __invoke(
        ...
        $form = $this->createForm(DeleteType::class, $panelist);
        $form->handleRequest($request);

        if ($form->isSubmitted() && $form->isValid()) {
            $panelist->delete($this->clock->now());
